...
INSERT INTO "new_habits" ("createdAt", "endDate", "id", "lastLevel", "lastStreak", "levels", "name", "repeatPattern", "startDate", "status", "streak", "streakBreaks", "updatedAt", "userId") SELECT "createdAt", "endDate", "id", "lastLevel", "lastStreak", "levels", "name", "repeatPattern", "startDate", "status", "streak", "streakBreaks", "updatedAt", "userId" FROM "habits";
DROP TABLE "habits";
